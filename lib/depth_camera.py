...
class DepthCamera:
    def __init__(self):
        ...
        self.minY = 140  # Minimum value of 0
        self.maxY = 280  # Maximum value of 479 (480?)
        self.target_mins_total = 500.0 # Number of values that average is taken over
        self.zero_limit = 30000 # When seeing this number of zeroed values in the frame, return a distance of 0 (min)
